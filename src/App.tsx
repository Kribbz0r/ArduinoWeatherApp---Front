...
function App() {
  ...
  useEffect(() => {
    const fetchWeatherData = async () => {
      const response = await fetch("http://192.168.0.128:8080/getWeatherData");
  ...
  useEffect(() => {
    ...
    fetchedDatas.forEach((fetchedWeatherData: WeatherData) => { fetchedDates.push(fetchedWeatherData.date), fetchedBrightnessValues.push(fetchedWeatherData.brightnessValue), fetchedBrightnessNotes.push(fetchedWeatherData.brightnessNote) });
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="graph-container">
        <BrightnessAndTempLines propDates={dates} propBrightnessValues={brightnessValues} propTemperatures={temperatures} />
      </div>
      <div className="graph-container">
